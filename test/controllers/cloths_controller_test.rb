...
class ClothsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cloth" do
    assert_difference('Cloth.count') do
      post cloths_url, params: { cloth: { number_of_cloths: @cloth.number_of_cloths, title: @cloth.title } }
    end
  ...
  test "should update cloth" do
    patch cloth_url(@cloth), params: { cloth: { number_of_cloths: @cloth.number_of_cloths, title: @cloth.title } }
